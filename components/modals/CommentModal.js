...
async function sendComment() {
 ...
 await updateDoc(docRef, {comments: arrayUnion(commentDetails) 
})
...
router.push("/"+ tweetDetails.id)
  ...
  return (
    <div>
      ...
      >
        <div className="w-full h-full relative sm:w-[600px] sm:h-[386px] rounded-lg bg-black border border-gray-500 text-white sm:p-10 p-4">
          ...
          <div className="mt-11">
            <div className="flex space-x-3 ">
              ...
              <div className="w-full">
                <textarea
                  className="w-full text-lg outline-none resize-none bg-transparent"

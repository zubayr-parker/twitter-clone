...
function Trending() {
  return (
    <div className=" hidden lg:flex flex-col ml-7 mt-4">
      ...
      <div className="flex space-x-3 bg-white bg-opacity-10 w-[400px] h-[44px] p-3 rounded-3xl">
        ...
        <div className="flex justify-between p-3">
          <div className="flex space-x-3">
            ...
            <div className="flex space-x-1">
              <h1 className="font-bold">N Mandela</h1>
               <BadgeCheckIcon className="w-[18px] text-blue-400"/>
            </div>
            <h1 className="text-[12px] text-gray-500 mt-1">@nelsonmandela</h1>  
            </div>
